...
public class LootRegistration {
    ...
    public static final DeferredRegister<LootNbtProviderType> LOOT_PROVIDERS =
            DeferredRegister.create(BuiltInRegistries.LOOT_NBT_PROVIDER_TYPE.key(), Mine_spawners_forge.MOD_ID);

    public static void register(BusGroup eventBus) {
        LOOT_MODIFIER_SERIALIZERS.register(eventBus);
        LOOT_FUNCTIONS.register(eventBus);
        LOOT_CONDITIONS.register(eventBus);
        LOOT_PROVIDERS.register(eventBus);
    }
    ...
    public static RegistryObject<LootNbtProviderType> CONTEXT_AND_BLOCK_ENTITY_LOOT_NBT_PROVIDER;
    static {
        ...
        CONTEXT_AND_BLOCK_ENTITY_LOOT_NBT_PROVIDER = LOOT_PROVIDERS.register("context_and_block_entity", () -> new LootNbtProviderType(ContextAndBlockEntityLootNbtProvider.MAP_CODEC));
    }
}
